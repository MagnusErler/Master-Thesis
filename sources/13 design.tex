...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/STM32_LR1110_interface.drawio.png}
...
Able to send \ac{GNSS} with \ac{GNSS} or \ac{GNSSNG}.
...
192 & & \ac{GNSSNG} port (for multiple NAV messages)  & \\
