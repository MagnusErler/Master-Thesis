...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/event_example.png}
    \caption{Example of Wi-Fi passive scan transaction.}
    \label{fig:event_example}
\end{figure}

Some \ac{SPI} commands generate an immediatele response by the LR1110, and therefor do not generate any \ac{EVENT} signal. Such as the command \lstinline[style=C++]{RequestTX(...)} as shown in fig.~\ref{fig:event_example_2}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/event_example_2.png}
    \caption{Example of a transaction which does not generate a \ac{EVENT} signal.}
